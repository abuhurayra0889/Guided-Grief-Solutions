...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About Haley - Guided Grief Solutions" },
      { name: "description", content: "Haley's journey from heartbreak to healing, and the mission behind Guided Grief Solutions." },
      { property: "og:title", content: "About Haley - Guided Grief Solutions" },
      { property: "og:description", content: "From sudden loss to a steady hand for other widows." },
    ],
  }),
  component: AboutPage,
});
...
function SectionA() {
  return (
    <StoryRow image={founderImg} alt="Portrait of Haley" heading="At age thirty-nine, my world shifted off its axis in an instant.">
      <p>I unexpectedly became a widow, and just two weeks after my husband passed, I brought our second daughter into a world that felt suddenly, agonizingly, deafeningly quiet. This loud silence echoed through every corner of my home and heart.</p>
      <p>In those early months of navigating new motherhood alongside profound loss, I kept thinking, I never want another widow to endure what I've endured. That is, drowning under the suffocating weight of paperwork, not knowing where to turn or whom to trust, and feeling as though I needed to prolong my own healing. It was in that struggle that Guided Grief Solutions was born.</p>
    </StoryRow>
  );
}
...
function SectionB() {
  return (
    <StoryRow image={aboutJourney} alt="A woman walking along a forest path at golden hour" reverse heading="I've learned that grief is deeply personal and that it isn't a process to be completed; it is a journey that must be honored.">
      <p>Unlike a process with a definitive end, a journey is something we walk through continuously, evolving and learning with every step. I have learned to integrate grief into my life, acknowledging the pain of old wounds while nurturing my whole self; mentally, emotionally, physically, and spiritually.</p>
    </StoryRow>
  );
}
...
function SectionC() {
  return (
    <StoryRow image={aboutPortrait} alt="Quiet moment by a window" heading="While I never would have chosen this path, I am profoundly grateful for the perspective it has gifted me." imgClassName="object-left">
      <p>I live with the deep understanding that tomorrow is never guaranteed, making every sunrise a precious, cherished gift. Slowly but surely, I’ve regained momentum, accepting that growth often looks like two steps forward and one step back. Through it all, I’ve awakened an inner resilience and strength I never knew could exist.</p>
      <p>As I continued forward on this new and unforeseen path, I realized that all of the pain, sleepless nights and heartache gave me a beautiful opportunity to give back and support other widows. Guided Grief Solutions was created to be the steady hand I wish I’d had, providing a centralized sanctuary that honors the widow as a whole person, not just a set of tasks.</p>
    </StoryRow>
  );
}
  ...
  return (
    <section className="py-5 md:py-10 bg-background">
      <div className="max-w-5xl mx-auto px-8 grid md:grid-cols-2 gap-12 md:gap-16 items-center">
        <div>
          <h2 className="font-display text-3xl sm:text-4xl text-foreground leading-tight tracking-tight">Strategies for healing and a path forward</h2>
          <div className="mt-6 space-y-4 text-sm text-muted-foreground leading-relaxed">
            <p>By combining personalized administrative guidance with carefully curated wellness and holistic resources, I offer a tailored roadmap for your physical, emotional, and integrative needs. My mission is to move you out of the exhausting cycle of constant task-switching and into a steadier, more supported rhythm, where necessary matters are handled more easily and healing is not postponed.</p>
            <p>I hope you will allow Guided Grief Solutions to help you navigate the complexities of loss, giving you the necessary space and time to breathe, to heal, and to eventually, rediscover your own light.</p>
            <p className="font-signature text-4xl text-[#D3ABA0] pt-2">Many life blessings,<br />Haley</p>
          </div>
        </div>
        <div className="rounded-2xl overflow-hidden aspect-[4/5] bg-secondary/40">
        ...
        <div className="bg-secondary/60 rounded-2xl px-8 md:px-12 py-10 grid md:grid-cols-[200px_1fr] gap-8 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="mt-3 text-sm text-muted-foreground leading-relaxed max-w-md">
              Navigating the administrative side of loss shouldn't stand in the way of your healing. Together, we can streamline the path forward. Need a moment to breathe right now? Check out today's affirmation. Daily affirmations are more than just words. They are soft whispers of truth designed to soothe your spirit and help you reclaim your inner strength.
            </p>
